...
public class ParameterizedTests {
    ...
    @ParameterizedTest
    @CsvFileSource(files = "src/test/resources/params/shoppinglist4.csv",
            numLinesToSkip = 1, delimiterString = "___")
    void csvFileSource_StringDoubleIntStringStringSpecifiedDelimiterEmptyAndNullValues(String name, double price,
                                                                     int qty, String uom,
                                                                     String provider) {
        System.out.println("name = " + name + ", price = " + price +
                ", qty = " + qty + ", uom = " + uom + ", provider = " + provider);
